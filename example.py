...
# the exponential birth rate function defined above, and a waning immunity rate = 0.5.
population = Population(death=0.00005, size=10000, birth_function=birth_rate_function, waning=0.5)
...
# Instantiate the Solver class, providing it with the population structure and the two strains to be
# modelled over 100 days.
